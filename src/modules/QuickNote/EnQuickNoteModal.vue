<template>
  ...
  >
    ...
    <div class="EnQuickNoteModalContainer">
      <div
...
const commandSwitchQuickNote: ICommand = {
...
onMounted(() => {
  ...
  if (!globalWindowData.value.isInEnWindow) {
